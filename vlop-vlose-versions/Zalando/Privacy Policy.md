...
If you have a question regarding this Privacy Notice or data protection at Zalando you can reach out to our Privacy Team by sending an email to [datenschutz@zalando.de](mailto:datenschutz@zalando.de). Please also send an email to our Privacy Team if you would like to request data access or data deletion, or in order to exercise other data protection rights provided in Art. 15-22 GDPR, including withdrawal of consent to marketing, opt out from newsletter etc. For more information see the sections [Which data protection rights do I have?](#chapter-11) and [Contact](#chapter-15).
...
Cooperation with external payment service providers and credit agencies is on a country-specific basis, in order to take country-specific features and requirements into account. Under [Who is my data forwarded to?](#chapter-10) you can find information on external payment service providers and under [Country-specific information](#chapter-17) you can find information on which credit agencies we work with in which countries. There you can also find special privacy policies which we provide you with on behalf of the relevant payment service providers and credit agencies.

### 1.5 Interests information

When you interact with our services, we collect data that tells us what content, topics, products, product types, brands or styles you are interested in. For example, we can compare your purchase data, content from saved wish lists or collections you have created yourself, and your age (if this information is available to us), with users with similar characteristics to deduce which styles and product categories you are interested in. This enables us to display the products most relevant to you first in your next search.
...
You can find further information on the processing of your data for advertising purposes under [“How does Zalando use my data for marketing?”](#chapter-09).
...
Please also refer to the notes on the processing of social network data related to social network features under [“Info on websites and apps”](#chapter-04) and [“Information about Social Media Fan Pages”](#chapter-05).

Zalando currently uses the Facebook messenger service and social plug-ins / logins for the following social networks:

*   Facebook Ireland Ltd., 4 Grand Canal Square, Grand Canal Harbour, Dublin 2, Ireland (“Facebook”). The link to Facebook's privacy policy is available here: [Facebook's Data Policy](https://www.facebook.com/about/privacy/).
*   Twitter Inc., 795 Folsom St., Suite 600, San Francisco, CA 94107, USA (“Twitter”). The link to Twitter's privacy policy is available here: [Twitter's Privacy Policy](https://twitter.com/en/privacy).
...
Some of our service-specific applications allow you to share photos and other personal content with us, other users or general third parties so that you can communicate with us or other users or personalise services, e.g. by a) uploading a profile picture or personal information to your profile; b) using the Zalando app's photo search function; c) communicating with a stylist; or d) creating and/or putting together outfits (e.g. by dressing an avatar with different items of clothing or by collecting and sorting items of clothing into collections you have created yourself), and then sharing these with other Zalando users or general third parties, together with personal information that allows conclusions to be drawn about your identity.

When you rate products, we collect the information you share in the process and can publish it in the context of our services. Additionally, your product rating can be forwarded to the brand of the rated product, who can in turn analyse and publish the rating.
...
You can find the web portal for Zalando’s applicant management system at: [https://jobs.zalando.com/](https://jobs.zalando.com/). The Zalando applicant management system has a service-specific privacy policy, which you can access here: [https://jobs.zalando.com/de/datenschutz](https://jobs.zalando.com/de/datenschutz).
...
In this chapter, we also inform you of the legal basis on which we process data for the individual purposes. Depending on the legal basis for our processing of your data, you may have additional data protection rights alongside your permanent rights such as the right to information. For example, in individual cases you have the right to object to the processing of your data. You can find further information under [“Which data protection rights do I have?”](#chapter-11).
...
The processing of payments for the execution of purchase agreements is provided by Zalando Payments GmbH. When it is unclear to which order or customer a certain payment belongs, Zalando SE analyses data, such as the IBAN or address, in order to assign incoming payments to the correct customer. Zalando SE and Zalando Payments GmbH jointly analyse limited customer data regarding complaints about orders and payments to reduce frictions in the payment-related customer experience. As with any contract of this type, we are happy to provide you with the essence of the agreement concluded in accordance with Article 26 GDPR. Zalando also uses the service of external payment providers for payment processing. You can find information on external payment providers under section [Who is my data forwarded to?](#chapter-10).

**Legal basis:** Insofar as the processing is necessary for the execution of a contract agreed with you or the provision of a service requested by you, the legal basis is Article 6 (1) b GDPR. Notwithstanding, the legal basis is Article 6 (1) f GDPR, where the processing is necessary for our overriding legitimate interests in the above-mentioned purposes.
...
**Legal basis:** The legal basis for the processing of your data for shopping personalisation within the framework of personalised services is Article 6 (1) b GDPR. Notwithstanding, the legal basis is Article 6 (1) f GDPR, where the processing is necessary for our overriding legitimate interests in the above-mentioned purposes.

### 2.3 Research, machine learning and artificial intelligence

We process the data collected on our customers for scientific research in the areas relevant to Zalando. As part of this we use combined insights about your preferences and interests to better understand your needs on a holistic level. This includes in particular the research areas of machine learning, artificial intelligence, natural language processing and deep learning. Research at Zalando concentrates on solutions to real, everyday online shopping problems and is meant to serve the improvement and development of the existing services range. In this way, for example, we can develop apps which can suggest products targeted to your interests and needs and recognise styles and assign products which correspond to your actual interests.

In doing this, we of course comply with recognised scientific data protection standards. This also means that we use your data for training purposes in connection with machine learning and artificial intelligence and only process it for research purposes in aggregated, anonymised or pseudonymised form, as far as reasonably possible and necessary, for example by replacing all identifiable data such as your name with other values.

**Find out more**

You can find further information on the subject of research and science at Zalando at [Zalando Research](https://research.zalando.com/).
...
You can find country-specific information on the credit agencies charged with carrying out the risk assessment and on the creditworthiness data used under [“country-specific information”](#chapter-17).
...
The risk assessment will not mean that you are not offered any payment method. If you are not in agreement with the payment methods offered, you can inform us of this in writing by letter or email at [datenschutz@zalando.de](mailto:datenschutz@zalando.de). We will then check the decision again, taking your viewpoint into account.

**Legal basis:** The legal basis for processing of your data is Article 6 (1) b GDPR, because it is necessary for the execution of necessary pre-contractual measures, as well as Article 6 (1) f GDPR, based on our legitimate interest in avoiding default risks.
...
You can find information on the credit agencies charged with carrying out credit checks in your country under [“Country-specific information”](#chapter-17). If your country is not listed here, we do not carry out credit checks in your country.

Depending on the result of the credit check, i.e. whether it is positive or negative, we will show you appropriate payment methods which you can use to continue and complete your purchase. If you are not in agreement with this, you can inform us of this in writing or by email at [datenschutz@zalando.de](mailto:datenschutz@zalando.de). We will then check the decision again, taking your viewpoint into account.
...
Before such data processing operations take place, your above-mentioned data might be used to test the efficiency of the respective procedure and/or the respective cooperation.

### 2.5 Transfer of data on outstanding debts to collection service providers

In the event that you have outstanding invoices that are not settled, we may work with service providers to send out reminder letters for payment. If outstanding debts are not settled despite repeated reminders for payment, we may transfer the data required to commission a collection service provider to a collection service provider for the purpose of collecting the debt. Alternatively, we may sell the debt to a collection service provider which is then able to file a claim in its own name. You can find information on the agencies charged with collection services in your country under ["Country-specific information"](#chapter-17).
...
We use your data as well as combined insights about your preferences and interests, also within the framework of data analysis, for advertising and market research, in particular for the following purposes:
...
Advertising services at Zalando are also offered by Zalando Marketing Services GmbH. [On the Zalando Marketing Services GmbH website](https://zms.zalando.com/)
...
*   [Google's Privacy Policy](https://business.safety.google/privacy/)
...
*   The creation of combined customer insights to train our machine learning models for more accurate recommendations and a better overall customer experience.
...
Zalando enables users to share content they have created and/or uploaded themselves, which may allow conclusions to be drawn about their identity, with specific recipients, recipient groups or general third parties within the scope of certain services, for example (but not exclusively) by sharing the content with third parties for the purposes of interaction and communication. In doing so, Zalando may enable said content's recipients to interact and communicate with other users, for example by sharing the content with third parties, by rating the content (e.g. ‘likes’) and/or by following a user.

Zalando may review and restrict this content to ensure that it complies with the **Community Guidelines** established by Zalando as well as any applicable legal provisions (‘moderation’). We also use external service providers for this moderation. These service providers review the content with some support from artificial intelligence (AI). AI-supported analysis enables quick and efficient detection of potentially problematic content, such as content that violates our **Community Guidelines** or is illegal. Your data will only be processed to the extent necessary for moderation.

**Legal basis**: The legal basis for processing your data for the purpose of interaction is Article 6(1)(b) GDPR and, notwithstanding this, Article 6(1)(f) GDPR if the processing is necessary for our overriding legitimate interests in the above-mentioned purposes.
...
You can find further instructions under [“Which data protection rights do I have?”](#chapter-11)
...
Personalised content is generally selected on the basis of all data stored on your customer account. This may be combined with insights from your activities across our services to create a more complete understanding of your preferences and interests.
...
In your customer account, you can view and manage most of the personal data we hold in connection with your account at any time. You can update this information to influence the personalisation of our recommender systems, e.g. by selecting your preferences. You can do this under “Your account” > “Data and privacy” > “Recommendation preferences” > “Profile information”.

Please note: the “Profile information” setting is a virtual switch that allows you to control personalisation preferences.
...
We set up password-protected personal access for users who register for a customer account or another service. If you do not log out again after logging in with your login details, most services automatically keep you logged in. Depending on the type of service, a cookie or similar technology is used for this. This function allows you to use part of our services without having to log in again every time. For security reasons, however, you will be asked to enter your password again if, for example, you want to change your profile information or submit an order. You can find more information under [“Personalised services”](#chapter-03).
...
We use plug-ins by the social network facebook.com, operated by Facebook Inc., 1601 S. California Ave, Palo Alto, CA 94304, USA (“Facebook”), on several websites. You can find the link to Facebook’s Privacy Policy here: [Facebook’s privacy policy](https://www.facebook.com/about/privacy/).

**Twitter social plug-ins**

We use plug-ins by the social network Twitter, operated by Twitter Inc., 795 Folsom St., Suite 600, San Francisco, CA 94107, USA (“Twitter”), on several websites. You can find the link to Twitter’s privacy policy here: [Twitter’s privacy policy](https://twitter.com/en/privacy).

**Pinterest social plug-ins**

We use plug-ins by the social network Pinterest, operated by Pinterest Inc., 651 Brannan Street, San Francisco, CA 94103, USA (“Pinterest”), on several websites. You can find the link to Pinterest’s privacy policy here: [Pinterest’s privacy policy](https://policy.pinterest.com/en/privacy-policy).
...
You can find further information under [“How does Zalando use my data for advertising?”](#chapter-09)

If you don’t want our advertising partners to use your device and access data for the purpose of onsite optimisation, click on “Save settings” in the cookie preferences, without previously selecting the category “Marketing”. If you have previously selected this cookie category, you can deselect it at any time:

*   Click on “Data preferences” at the bottom of the Zalando website or “Data tracking” on the Zalando Lounge website. Remove the checkmark in the cookie category “Marketing” and confirm your selection by clicking on “Save settings”.
*   In the app, you can make this change in “App settings” under “Data tracking”.

**Info on website cookies**

Our websites use cookies. Accepting cookies isn’t a prerequisite for visiting our websites. It is however important to note that the functionality of our websites might be limited if you don’t accept cookies. Some web browsers also have a setting that lets you choose not to accept cookies, or to be asked for consent.
...
*   Essential cookies: these cookies are necessary for optimal navigation, operation and security of the website. For instance, they enable the shopping cart function – the products in your shopping cart remain there while you continue shopping. They are also used to save certain inputs and settings you make, so that you don’t have to re-enter them all the time, and to tailor Zalando content to your individual interests. Without essential cookies, our website can’t be used at all or only in a limited way.
*   Performance and analytics cookies: these cookies collect device and access data in order to analyse how our website is used. This includes capturing which areas of the website are used (browsing habits), how fast content is loaded, and whether errors occur. These cookies only contain anonymous or pseudonymous information and are only used to improve our website and to find out what our users are interested in, as well as to measure the effectiveness of our advertising. Statistics cookies can be blocked without affecting the navigation or operation of our website.
*   Marketing cookies: these cookies contain identifiers and collect device and access data, in order to tailor personalised advertising on Zalando websites to your individual interests. Advertising partners operating online advertising networks also use the marketing cookies on our website to collect device and access data. This way, other providers’ websites and apps can also show you personalised advertising that matches your interests (retargeting). Marketing cookies can be blocked without affecting the navigation or operation of our website. However, your shopping experience and advertising will be less personalised if you block these cookies.

We have collected country-specific overviews of all cookies used in the Zalando shop. You can find these under [“Information on individual websites”](#chapter-18).
...
Our websites and apps use cookies and similar tracking technologies from advertising partners operating an online advertising network, provided you have accepted marketing cookies. This also enables our advertising partners to collect your device and access data in order to show you personalised ads tailored to your interests on other websites and in other apps, including those from other providers (e.g. advertising based on the products you previously viewed on Zalando).
...
*   Deselect marketing cookies under “Data preferences” at the bottom of the Zalando website or “Data tracking” on the Zalando Lounge website. In the app, you can make this change in “App settings” under “Data tracking”.
*   For other websites and apps you can also deactivate retargeting by participating online advertising networks on the deactivation page of the European Interactive Digital Advertising Alliance (EDAA): [Deactivate further advertising](http://www.youronlinechoices.com/de/praferenzmanagement/).
...
You can find out which tracking tools our websites and apps use under [“Information on individual websites”](#chapter-18).

You can keep your data from being collected for usage analysis through performance and analytics cookies by deselecting the respective cookie category. If you have previously selected this cookie category, you can deselect it at any time:

*   You can find these settings at the bottom of the Zalando website under “Data preferences” or on the Zalando Lounge website under “Data tracking”. In the app, you can make this change in “App settings” under “Data tracking”.
...
When you visit our fan pages, Zalando collects all communications, content and other information that you provide us directly, e.g. when you post something on a fan page or send us a private message. Of course, if you have an account on the social network, we can also see your public information, such as your username, information in your public profile, and content that you share with a public audience. For more information, see ["Which data does Zalando process?”](#chapter-01).
...
You can view the agreement with Facebook here: [https://www.facebook.com/legal/terms/page\_controller\_addendum](https://www.facebook.com/legal/terms/page_controller_addendum)

Facebook has summarised the important parts of this agreement (including a list of Page Insights data) for you here: [https://www.facebook.com/legal/terms/information\_about\_page\_insights\_data](https://www.facebook.com/legal/terms/information_about_page_insights_data)
...
Of course, your privacy rights described in ["Which data protection rights do I have?"](#chapter-11) also apply to the processing of your data in connection with our fan pages.
...
You can change the settings for the newsletter services anytime yourself. For Zalando Shop and Lounge by Zalando you can choose your settings in the corresponding preference centre ([www.zalando.\[locale\]/messages](http://www.zalando.%5Blocale%5D/messages) for the Zalando shop and [https://www.zalando-lounge.de/myaccount/newsletter](https://www.zalando-lounge.de/myaccount/newsletter) for the Lounge by Zalando) - please visit the preference centre so that we can best respond to your wishes and interests.
...
Furthermore, you may receive commercial messages from Zalando (subject to competition law) , e.g. individual recommendations after your last purchase, without having subscribed to a newsletter. You can find further information about this under [“Individual product recommendations by email and push service”](#chapter-07).
...
Feel free to contact [datenschutz@zalando.de](mailto:datenschutz@zalando.de) to unsubscribe or in case you experience any difficulties.

**Unsubscribing from Newsletters**

If you wish to unsubscribe from the Zalando shop newsletter, you can use the link provided in every newsletter email. If you are also subscribed to newsletters sent by another Zalando shop like Lounge by Zalando or Zalando Outlets, please follow the unsubscribe link in those newsletters or contact [datenschutz@zalando.de](mailto:datenschutz@zalando.de) to unsubscribe from all newsletters. Please be aware that unsubscribing from one Zalando shop service does not automatically entail unsubscription from all services.

### 6.3 Which data is collected?

If you subscribe to a newsletter, we temporarily save your IP address as well as the time of your subscription and confirmation. This allows us to verify that you have actually subscribed to the newsletter and to detect any unauthorised use of your email address. We assign a randomly generated ID number (newsletter ID), which we use to unsubscribe you from the newsletter, if you request us to do so.

We collect device and access data when you interact with newsletters, transactional emails and push notifications. For ratings of this kind, newsletters include links to image files saved on our web servers. When you open a newsletter, your email platform will upload these image files, also known as tracking pixels, from our web servers. This enables us to track if and when a newsletter has been opened. If you click on a link in the newsletter, the tracking pixels allow us to determine which content was read. We use this information to personalise our communications and make them more relevant to you. We aggregate the data and use your customer ID to connect your newsletter subscription to your customer account. We do this in order to personalise the content of the newsletter according to your interests and user habits and to statistically analyse the way our users interact with our newsletter service.

This shopping personalisation is an integral part of the Zalando Shop newsletter.

You can disable the display of images in your email platform. However, you won’t be able to view the newsletter in its entirety in that case.
...
You can also find further information about the personalisation of individual recommendations under [“Personalised services”](#chapter-03).

If you do not wish to receive any individual product recommendations from us by email, you can informally object to it at any time by clicking the unsubscribe link which you will find in every email, or by sending an email to [datenschutz@zalando.de](mailto:datenschutz@zalando.de). Push notifications can be deactivated in the Zalando app by choosing “Your account” > “App settings” > “Notifications” and flipping the virtual switch to the “Off” position.
...
In creating target groups we use our own findings from data analysis on our users’ usage and purchasing behaviour and customers as well as our market research on user segmentation which we apply to the user data collected by Zalando. In doing this we especially consider the combined customer insights, which are composed of data such as aggregated, pseudonymised or anonymised shopping data, search histories, interests data and demographic profile data as well as device and access data.
...
If you don’t want our advertising partners to collect your device and access data, click on “Save settings” in the cookie preferences, without previously choosing the category “Marketing”. If you have previously selected this cookie category, you can deselect it any time:

*   Click on “Data preferences” at the bottom of the Zalando website or “Data tracking” on the Zalando Lounge website. Remove the checkmark in the cookie category “Marketing” and confirm your selection by clicking on “Save settings”. In the app, you can make this change in the “App settings” under “Data tracking”.
...
If you don’t want us to use your data to show you personalised advertising on social media, you can object to the transfer of your data by deselecting the cookie category “Marketing”. If you have already accepted marketing cookies, you can reverse this selection any time:
...
*   [Information on Facebook adverts](https://www.facebook.com/about/ads/)
*   [Advertising settings for Facebook](https://www.facebook.com/settings?tab=ads)

Google (Google advertising network, YouTube, Google search):

*   [Information on Google adverts](https://policies.google.com/technologies/ads?hl=de)
*   [Advertising settings for Google](https://adssettings.google.com/authenticated)
...
You can get further information on the operators of the respective advertising spaces and the online advertising networks charged with mediating them. You can find an overview of advertising partners and information on deactivation under [“Information on individual websites”](#chapter-18).

You can deactivate the processing of your data for retargeting at any time:

*   Deselect marketing cookies under “Data preferences” at the bottom of the Zalando website or “Data tracking” on the Zalando Lounge website. In the app, you can make this change in “App settings” under “Data tracking”.
*   You can deactivate retargeting by participating online advertising networks for our websites on the deactivation page of the European Interactive Digital Advertising Alliance (EDAA): [Deactivate further advertising](http://www.youronlinechoices.com/de/praferenzmanagement/).
...
When you leave a rating on one of our platforms, we can forward the content of your rating (e.g. text, star rating, chosen user name) to the manufacturer or brand of the product you rated. This happens both for products sold directly by us and those sold by a partner, and is intended to enable brands to analyse your feedback for quality management and product development. They can also publish your rating for their own marketing purposes (e.g. on their own website). In case of further data processing by the brand, the responsibility for this lies with the brand itself.
...
*   **Adyen N.V., Simon Carmiggeltstraat 6-50, 1011 DJ Amsterdam, the Netherlands**. Please find more information in Adyen [Privacy Policy](https://www.adyen.com/policies-and-disclaimer/privacy-policy).
*   **American Express Payment Services Limited, a branch office in Germany, Theodor-Heuss-Allee 112, 60486 Frankfurt am Main**. Please find more information in American Express [Privacy Policy](https://www.americanexpress.com/de/legal/online-datenschutzerklarung.html?inav=de_legalfooter_dataprivacy).
*   **Elavon Financial Services DAC, a branch office in Germany, Lyoner Str. 36, 60528 Frankfurt am Main**. Please find more information in Elavon [Privacy Policy](https://www.elavon.co.uk/privacy-policy.html).
*   **Worldpay B.V. Claude Debussylaan 16, 6th Floor, 1082 MD Amsterdam, the Netherlands**. Please find more information in Worldpay [Privacy Policy](https://online.worldpay.com/terms/privacy).
*   **iDeal by Deutsche Bank AG, a branch office in the Netherlands, De Entree 195, 1101 HE Amsterdam**. Please find more information in Deutsche Bank [Privacy Policy](https://www.db.com/company/en/data-protection.htm?kid=dataprotection.redirect-en.shortcut).
*   **Svea Payments Oy, Mechelininkatu 1a, 00180 Helsinki**. Please find more information in Svea Payments [Privacy Policy](https://www.sveapayments.fi/terms-and-conditions-privacy-policies).
*   **BS PayOne by PayOne GmbH, Lyoner Straße 9, 60528 Frankfurt am Main**. Please find more information in PayOne [Privacy Policy](https://www.payone.com/dsgvo/).
*   **PayPal (Europe) S.à r.l. et Cie, S.C.A., 22-24 Boulevard Royal, 2449 Luxembourg, Luxembourg**. Please find more information in Paypal [Privacy Policy](https://www.paypal.com/us/webapps/mpp/ua/privacy-full).
*   **przelewy24 by PayPro Spólka Akcyjna, ul. Kanclerska 15, 60-327 Poznań and DialCom24 sp. z o.o., ul. Kanclerska 15, 60-327 Poznań**. Please find more information in przelewy24 [Privacy Policy](https://www.przelewy24.pl/eng/information-obligation-gdpr-payer).
*   **Klarna Bank AB (publ), Sveavägen 46, 111 34 Stockholm.** Please find more information in the Klarna [Privacy Policy](https://www.klarna.com/international/privacy-policy/).

### 10.6 Credit agencies

Cooperation with external credit agencies for fraud prevention, payment method selection and credit checks is country-specific, in order to take account of country-specific features and requirements. Under [Country-specific information](#chapter-17) you can find information on which external payment service providers and credit agencies we work with in which countries. There you can also find special privacy policies which we provide you with on behalf of the relevant payment service providers and credit agencies.

### 10.7 Collection service providers

Work is carried out in collaboration with external collection service providers specific to each country to allow for peculiarities and requirements in each country. Under [Country-specific information](#chapter-17), you can find information on which external collection service providers we work with in which countries. There you can also find special privacy policies which we provide you with on behalf of the relevant payment service providers and credit agencies.

### 10.8 Social media networks

As part of advertising campaigns we forward data to social network providers within the scope of data protection law. You can find further information under [“How does Zalando use my data for advertising?”](#chapter-09).
...
Email: [datenschutz@zalando.de](mailto:datenschutz@zalando.de)
...
You can find more information on the criteria for determining the storage period in this data protection information under point 12. [When will my data be deleted?](#chapter-12).
...
You will find more detailed information on this subject in Google’s [Privacy Statement](https://policies.google.com/privacy?hl=de) and in the [Additional Terms of Service for Google Maps](https://www.google.com/intl/de/help/terms_maps/).
...
The service provider of credit checks for consumers in Germany is **CRIF GmbH, Leopoldstraße 244, 80802 München**.

You can find detailed privacy policies for CRIF GmbH in the sense of Article 14 GDPR, especially information on the business purpose, the purposes of data storage, data recipients as well as other data protection rights against CRIF GmbH here: [https://www.crif.de/datenschutz](https://www.crif.de/datenschutz).
...
The service provider of credit checks for consumers in Austria is **CRIF GmbH, Leopoldstraße 244, 80802 München, DE**.
...
You can find out which cookies we use here. For an overview of all the cookies we use please click [here](#uc-info-modal-show).