...
Site owners should make sure they don't violate the [Unwanted Software Policy](https://www.google.com/about/company/unwanted-software-policy.html) and [follow our guidelines](https://developers.google.com/search/docs/monitor-debug/security/malware#guidelines).
...
_Third-party content_ is content that's created by an entity that's separate from the established host site. Examples of separate entities include users of that site, freelancers, white-label services, and content created by people not employed directly by the host site.
