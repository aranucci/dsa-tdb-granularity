...
M. YOUR SUBMISSIONS TO OUR SERVICES 

N. FAMILY SHARING 

O. SEASON PASS AND MULTI-PASS 

P. ADDITIONAL APP STORE TERMS 

Q. ADDITIONAL TERMS FOR APP STORE, APPLE BOOKS, APPLE PODCASTS, AND SELECT CONTENT   

R. ADDITIONAL APPLE MUSIC TERMS

S. ADDITIONAL APPLE FITNESS+ TERMS  

T. RESELLER MEMBERSHIP

U. MISC. TERMS APPLICABLE TO ALL SERVICES
...
Right of withdrawal: If you choose to cancel your order, you may do so within fourteen (14) days from when you received your receipt without giving any reason.

To cancel your order, you must inform us of your decision. To ensure immediate processing we recommend you use Report a Problem to cancel all items with the exception of Complete My Season, which can be cancelled by contacting Apple Support. Subscription services can only be cancelled following the initial subscription and not upon each automatic renewal. You also have the right to inform us using the model withdrawal form below or by making any other clear statement. If you use Report a Problem we will communicate acknowledgement of receipt of your withdrawal to you without delay.

To meet the withdrawal deadline, you must send your communication of withdrawal before the fourteen (14) day period has expired.

Effects of withdrawal: We will reimburse you no later than fourteen (14) days from the day on which we receive your notice. We will use the same means of payment as you used for the Transaction, and you will not incur any fees for such reimbursement.

Exception to the right of withdrawal: You cannot cancel your order for the supply of Content if the delivery has started upon your request and acknowledgement that you thereby lose your right of withdrawal.

Model withdrawal form:

\- To Apple Distribution International Ltd., iTunes Store Customer Support, Hollyhill Industrial Estate, Hollyhill, Cork, Republic of Ireland, [rightofwithdrawal@apple.com](mailto:rightofwithdrawal@apple.com%20):
...
You may add, notify, or remove a Legacy Contact for your Apple Account as described in [http://support.apple.com/HT212360](http://support.apple.com/HT212360). A Legacy Contact’s access to your Apple Account is limited as described in [http://support.apple.com/HT212361](http://support.apple.com/HT212361).
...
To learn about accessibility features and other accessibility-related information related to the Services, visit [https://www.apple.com/accessibility/labels](https://www.apple.com/accessibility/labels).
...
If you fail to comply with your essential obligations in this Agreement, such as your payment obligation or the obligations set out in the sections “YOUR SUBMISSIONS TO OUR SERVICES” or “ACCOUNT”, or in the event of fraud, Apple may: (i) terminate this Agreement and/or your Apple Account, and you will remain liable for all amounts due under your Apple Account up to and including the date of termination; and/or (ii) terminate your license to the software; and/or (iii) preclude your access to the Services. In deciding whether to terminate or suspend your access to the Services, Apple will take into account a range of factors, including the seriousness of the failure and whether you have previously failed to comply with this Agreement.

Apple further reserves the right to modify, suspend, or discontinue the Services (or any part or Content thereof) at any time for technical or operational reasons, and Apple will not be liable to you or to any third party should it exercise such rights. To the extent possible, Apple will warn you in advance of any modification, suspension or discontinuance of the Service. The modification, suspension, or discontinuance of the Service will not affect the Content that you have already acquired and downloaded. However, you may be unable to authorize additional computers to use such Content. If Apple discontinues a Service that is a Subscription you have already paid for, Apple will issue you a refund.
...
If you have questions about our Services, including, for example, about billing and Subscriptions or your Apple Account, please visit [https://getsupport.apple.com](https://getsupport.apple.com/), where you can connect with us by phone, email, or chat after selecting the issue most relevant to you. If you choose to chat with us, you have the option to download a transcript of your conversation, which will include the date and time of when the conversation took place.
...
Apple reserves the right to modify this Agreement and to add new or additional terms or conditions, which may be necessary if, for example, Apple adds a new service or adds, expands, and/or amends features and functionalities to a Service, or if applicable law and/or practices change. Apple may also modify this Agreement to improve readability or update contact information. Such modifications and additional terms and conditions will be communicated to you and if accepted, will be effective immediately and will be incorporated into this Agreement. In the event you refuse to accept such changes, you may not be able to make future purchases related to any Services or Content governed by this Agreement. In any event, the Content you have already acquired and downloaded, and any Apple Subscription, will not be affected by your refusal to accept such changes.
...
If you believe that any Content available through the Services infringe a copyright claimed by you, please contact Apple at [https://www.apple.com/legal/internet-services/itunes/itunesstorenotices](https://www.apple.com/legal/internet-services/itunes/itunesstorenotices/). This is the fastest way for us to process your notification of claimed infringement. The slower method to reach our designated agent and to process your notification is to send a proper and complete notification of claimed infringement to the mailing address listed below.
...
Email: [copyrightnotices@apple.com](mailto:copyrightnotices@apple.com%20) 
...
(ii) it is not a reasonably foreseeable result, at the time of the conclusion of the Contract, of any such breach by Apple;

(iii) any increase in loss or damage results from breach by you of any term of this Agreement;

(iv) it results from a decision by Apple to remove or deny access to any information or content, to suspend your access to the Service, or to take any other action during an investigation of a suspected violation of the Agreement by you;

(v) it results from a decision by Apple to remove or deny access to any information or content, to terminate your access to the Service, or to take any other action as a result of the breach of the Agreement by you, in the conditions provided by the section “TERMINATION AND SUSPENSION OF SERVICES”; or

(vi) it relates to loss of income, business or profits in connection with your use of the Services, or any loss of data or corruption of data that would arise from negligence in your use of the Services.
...
Alternative Dispute Resolution. Apple is not required to participate in, and does not intend to participate in, any alternative dispute resolution process. In case you experience a problem, contact Apple Support [https://support.apple.com/contact](https://support.apple.com/contact%E2%80%9C?)[.](https://support.apple.com/contact%E2%80%9C?)

You hereby grant Apple the right to take steps Apple believes are reasonably necessary or appropriate to enforce and/or verify compliance with any part of this Agreement. You agree that Apple has the right, without liability to you, to disclose any data and/or information to law enforcement authorities, government officials, administrations, courts, and/or a third party, as Apple believes is reasonably necessary or appropriate to enforce and/or verify compliance with any part of this Agreement. This right includes without being limited to Apple's right to cooperate with any legal process relating to your use of the Services and/or Content, and/or a third-party claim that your use of the Services and/or Content is unlawful and/or infringes such third party's rights).
