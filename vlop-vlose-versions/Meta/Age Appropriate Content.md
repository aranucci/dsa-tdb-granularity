...
We're continuously evolving our approach to help make sure that we're providing teens with safe, age-appropriate experiences and to incorporate the best possible research and expert advice to bring parents peace of mind. We also wanted to more closely align to an independent standard that's already familiar to families, so we reviewed our age-appropriate guidelines – the guidelines that determine what content we hide from teens and avoid recommending to them – against film ratings for aged 13+. This means that teens will see content that's generally similar to what they'd see in an age-appropriate film.

Just like you might see some suggestive content or hear some strong language in a film rated appropriate for 13+, teens may occasionally see something like that on Instagram – but we're going to keep doing all that we can to keep those instances as rare as possible. We recognise that no system is perfect, and we're committed to improving over time.

_\*There are lots of differences between social media and films. We didn't work with the MPA when updating our content settings, and they're not rating content on Instagram. Rather, we drew inspiration from the MPA's public guidelines, which are already familiar to parents._

* * *

Multiple layers of protection

**For everyone:** We remove content that violates our [Community Standards](https://transparency.meta.com/en-gb/policies/community-standards/). We also have a higher bar for the type of content that we recommend.

❌ Content that we remove

Our [Community Standards](https://transparency.meta.com/policies/community-standards/) outline the kinds of content that we don't allow on Facebook and Instagram. We remove this content completely for everyone – including teens – whenever we become aware of it. When we remove content that breaks these rules, we may also [apply a strike](https://transparency.meta.com/enforcement/taking-action/counting-strikes/) to the account that shared it and we disable accounts that repeatedly or severely violate our policies. These policies are designed to protect everyone in our community, including teens.
...
We don't allow content that can abuse or exploit people, such as posts encouraging non-consensual sexual activity, or sharing or asking for child abuse material. For example, we would remove:
...
❌ A post using dehumanising speech against people based on their race, religion, ethnicity, gender identity or sexual orientation.

❌ A comment mocking the victims of sexual assault.

❌ A post that threatens to release personally identifiable information (such as a passport number) or incites harassment towards someone.
...
We make certain exceptions for graphic content in medical contexts or when shared to raise awareness. Where we do allow graphic content, we typically cover it with a warning screen to let people know that the content may be sensitive before they click on it.

* * *

Nudity, sexual activity and sexually explicit language
...
For full details on the content that we remove, see our [Community Standards](https://transparency.meta.com/policies/community-standards/).

🛡️ Content we avoid recommending

We make recommendations in places such as Instagram's Reels or Explore or Facebook Feed to help people discover new content that they may be interested in. We have [guidelines](https://help.instagram.com/313829416281232/) about the kind of content that can be recommended, and avoid making recommendations that could be low-quality, objectionable or particularly sensitive – even when the content isn't severe enough to remove. This is because we think that there should be stricter standards when showing people content from accounts that they haven't chosen to follow.

**⚠️ Additional content that we hide for teens**

**Teens:** We offer extra protections for teens under 18. We hide more content, beyond what we remove for everyone, and also avoid recommending content to teens that is recommendable to adults. These policies are inspired by film ratings for aged 13+ and are designed to help make sure that teens see content that's similar to what they'd see in an age-appropriate film. On Instagram, teens or their parents can also opt in to a more restrictive setting called limited content, and teens can only access a third, more permissive setting – called more content – with a parent's permission

**13+ (the default):** 13+ (the default): The 13+ content setting is inspired by film ratings for aged 13+, and is on for teens by default. We've worked with youth experts around the world to understand what types of content may be appropriate for adults, but too mature for teens under 18, and we reviewed these age-appropriate guidelines against film ratings for aged 13+. In this setting, we'll hide additional content from teens beyond what we already remove for everyone. This means that while adults will still have access to this content, teens won't be able to see or interact with it, even if it's shared by an account that they follow in their Feed or Stories. We'll also prevent teens from discovering, following and interacting with accounts that primarily share content that's not age-appropriate.

Click here to see some of the types of content that we'll hide for teens in this default setting
...
⚠️ A story where someone is talking about their own extreme weight loss behaviour.
...
We'll also avoid recommending more types of content, even if it's in line with film ratings for aged 13+. A lot of the content that we avoid recommending to adults is already hidden completely from teens, but we go further for teens and avoid recommending additional types of content – such as photos or videos that may be seen as implicitly sexual, strong swearing or risky stunts, such as jumping from heights.

**Limited content:** On Instagram, for parents who prefer extra controls, we've introduced a new, even more restrictive setting called limited content. When the limited content setting has been turned on, we will apply our content filters more strongly to hide even more content from the Teen Account experience. We'll also further limit search results and turn off teens' ability to see, leave or receive comments under posts.

**More content:** Teens can only switch to the "More content" setting with a parent's permission, which parents can only provide via parental supervision. In this setting, teens will still benefit from automatic protections that hide more content from teens than we do for adults, and we will still remove content completely if it violates our Community Standards. However, teens may be recommended some content that they wouldn't be in the 13+ and limited content settings, and we won't hide entire accounts that share age-inappropriate content. The more content setting won't provide the stricter content restrictions across Live, comments and search that are part of the 13+ and limited content settings.

* * *

How to report violating content

We work hard to identify content that breaks our rules, and we find most of the content we remove proactively using our technology before it's reported to us. If you see something we missed, please help make our platforms a safer place by reporting it on either [Facebook](https://www.facebook.com/help/1380418588640631) or [Instagram](https://help.instagram.com/2922067214679225). All reports are anonymous.

* * *

Additional resources

Our Community Standards contain the details on the kinds of content we remove and age-restrict for each policy area. To read them, [click here](https://transparency.meta.com/policies/community-standards).

We've also developed technology that proactively identifies potentially suspicious adults, such as an adult who has been repeatedly blocked or reported by teens, or if an adult repeatedly searches for violating content. We won't recommend suspicious adults to teens, and we won't recommend teens to suspicious adults. You can read more about this [here](https://about.fb.com/news/2023/12/combating-online-predators/).

You can read more about the ways that we help keep our community safe on our [Safety Centre](https://about.meta.com/actions/safety/), and the ways that we support teens and families on our [Family Centre](https://familycenter.meta.com/).