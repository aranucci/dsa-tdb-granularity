...
Google’s ranking systems are designed to sort through hundreds of billions of webpages and other digital content to present the most relevant, useful results on the first page in a fraction of a second.
      ...
      ![A person sorting through Google Search results](https://www.gstatic.com/marketing-cms/assets/images/88/f2/99cbaaee4670ad69e152c3b32bed/ranking-results-automatically-generating-and-ranking-results.png=n-w543-h305-fcrop64=1,00000050ffffffb0-rw)
...
People expect Search to deliver quality results in a fraction of a second. As we improve Search and build new features, living up to this expectation is a priority.  
  
We focus on reducing "latency," which is a measurement of the time between when a user enters a search and when they see results. Our teams look at every component of Search to find ways to shave off milliseconds. Any increase in latency (from a new feature or change to Search) must be offset by making some other part of Search faster. This drives teams to continually optimize — phasing out slower code and lesser-used features and improving Search.  
  
Trimming time off of individual queries collectively saves people millions of hours each day.
...
*   [Meaning](#meaning)
*   [Relevance](#relevance-badcafdffd)
*   [Quality](#quality)
*   [Usability](#usability)
*   [Context](#context)
...
### Meaning of your query
      ...
      ![Illustration of search fields interpreting the word change in different contexts](https://www.gstatic.com/marketing-cms/assets/images/1d/3f/18c9f41f46d5943126fe54c017c8/hsw-ranking-results-m2-query-1.png=n-w543-h459-fcrop64=1,00000eabfffff155-rw)
...
We also use aggregated and anonymized interaction data to assess whether search results are relevant to queries. We transform that data into signals that help our machine-learned systems better estimate relevance. Just think: when you search for “dogs,” you likely don’t want a page with the word “dogs” on it hundreds of times. With that in mind, algorithms assess if a page contains other relevant content beyond the keyword “dogs” - such as pictures of dogs, videos, or even a list of breeds.
      ...
      ![Illustration of a magnifying glass examining search results for bicycles](https://www.gstatic.com/marketing-cms/assets/images/0f/55/871517d1417a9d060ce036d9b1dd/hsw-ranking-results-m3-relevance-1.png=n-w1134-h756-fcrop64=1,00000000ffffffff-rw)
...
### Quality of content
      ...
      ![Illustrating representing a number of competing pages, with one selected as having the highest quality for the user](https://www.gstatic.com/marketing-cms/assets/images/d5/05/4ca1fad244979cf970a466ef67d0/hsw-ranking-results-m4-quality-1.png=n-w1134-h756-fcrop64=1,00000000ffffffff-rw)
...
Content on the web and the broader information ecosystem is constantly changing. We continuously measure and assess the quality of our systems to ensure that we’re achieving the right balance of information relevance and authoritativeness to maintain your trust in the results you see.
      ...
      ![Search result with image of bicycle and green check mark indicating good usability](https://www.gstatic.com/marketing-cms/assets/images/29/0c/34728ea94b7ea3a55ff487e94fe3/hsw-ranking-results-m5-usability-1.png=n-w592-h362-fcrop64=1,0aca0000f536ffff-rw)

### Usability of content

Our systems also consider the usability of content. When all other signals are relatively equal, content that people will find more accessible may perform better. For example, our systems look at [page experience aspects](https://developers.google.com/search/docs/guides/page-experience#signals) like mobile-friendly content that loads quickly, an important consideration for mobile users.

### Context and settings

      ![An illustration of the globe showing different regional interpretations of the word football](https://www.gstatic.com/marketing-cms/assets/images/e7/dd/15f6f6be48cca5edb9d59c980f72/hsw-ranking-results-m6-context-1.png=n-w1136-h852-fcrop64=1,00000000ffffffff-rw)
...
*   [Your data in Search](https://www.gstatic.com/gumdrop/files/hsw-privacy-controls-v5.pdf)
*   [Google Preferences](https://www.google.com/preferences)
*   [My Google Account](https://myaccount.google.com/)
*   [Google SafeSearch](https://support.google.com/websearch/answer/510?hl=en)