...
**Data Retention Schedule:** We retain your information only as long as necessary to provide our services. The detailed data retention schedule below explains how long different types of information are stored and the reasons for retention
...
[**Compliance**]( This section provides further information as to what sort of Content is prohibited on the Website. It also provides useful links to our [Community Guidelines]( as well as to other explanatory and useful information that you have to be aware of when using the Website.
...
[**Recommender System Guidelines**]( This policy outlines how we tailor recommendations to Users, prioritizing their privacy and safety, as well as compliance with applicable laws.

[**Trust and Safety**]( This section includes the applicable policies and guidelines that all Users should be complying with, including, but not limited to:
...
the Content does not contravene to any applicable laws and does not subject this Website to any claims, demands, lawsuits, regulatory actions or any actual, potential or risk of liability, or any threats thereof;

you own the rights to use the Content on this Website and that the Content does not infringe on the rights (including intellectual property rights) of a third party and, that you have obtained the consent and release for every individual appearing in your Content, including the right for you to use and upload the Content on this Website;

for every individual appearing in your Content you have carefully ascertained and examined a valid governmental photo identification demonstrating that they are at least 18 years of age on the day they are photographed, filmed or otherwise appearing in such Content (this applies to all individuals, whether identifiable or not, or whether nude or not);

with respect to the Content, you, or the producer of the Content, have collected and maintained the records required under 18 U.S.C. § 2257 et. seq., as modified from time to time in compliance with the rules and regulations set forth in 28 C.F.R. § 75 et. seq., as modified from time to time, and any other applicable records keeping or age verification laws;

that Content Partner affirms that no individual appearing in the Content has been convicted of crimes relating to sexual assault, sexual exploitation of a minor, trafficking, and other related criminal offences;

the Content may be used for training purposes;

the Content is not a duplicate of another piece of Content uploaded by you or anyone else;

the Content complies with this Website’s [Terms of Service]( and our Privacy Notice.
...
In conjunction with the provisions of these [Terms of Service,]( the [Non-Consensual Content policy]( the [Child Sexual Abuse Material policy,]( and our Privacy Notice, the guidelines found [here]( are also in effect. You are solely responsible for familiarizing yourself with the latest version of these guidelines, as they are updated from time to time.
...
Your submitted information is then verified by a third-party service provider we collaborate with, by means of biometric processing (please see our [Privacy Notice]( for more information).
...
We may, in our sole discretion, require you to provide us multiple forms of identification to establish proof of adulthood and identity. Facial verification and an assessment of the authenticity of the aforementioned documents may also be required in the process of our verification of your age and identity. Our collection, use and disclosure of such information and documentation is governed by our [Privacy Notice.](
Models’ Commission
...
We may make available certain paid features in exchange for one-time or recurring fees (each a “Paid Service”). Your use of Paid Services and any transactions related to the purchase of such Paid Service are subject to the [Paid Service Terms](
...
The Model has requested deletion of their account; or

The Model has requested to be downgraded to a regular User account; or

The Model has been permanently banned due to Disciplinary Action.
...
This Website is operated by Aylo Freesites Ltd, Block 1, 195-197 Old Nicosia-Limassol Road, Dali Industrial Zone, Cyprus 2540. All notices of copyright infringement claims should be sent to the copyright agent designated in our [Copyright Policy]( in the manner and by the means set forth therein.
