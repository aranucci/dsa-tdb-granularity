...
Publishers who share video content on X are a critical part of the conversation happening on our platform each day. The Amplify Publisher Program was created to make it easy for publishers to monetize video content on X, and also turn-key for advertisers to align with brand-safe content. Not all publisher content is suitable for monetization through the Amplify Publisher Program; the guidelines outlined below should help publishers understand what content may not be eligible for monetization.

All videos and related posts monetized through the Amplify Publisher Program must comply with the below set of guidelines. X reserves the right at its discretion to not show ads, and thus remove monetization, on content we believe is not suitable for advertisers.
How we review publisher monetized content

We take all components of a monetized post into consideration, including:
...
Videos and related posts selected for monetization through the Amplify Publisher Program must follow these guidelines.
...
For more detailed information on these categories please read our [brand safety policy](

If your monetized video includes content that egregiously violates the guidelines outlined above, or violates the policies noted in the program’s Terms of Use, your account may be subject to X's 3-strike policy. Each strike will be handled as follows:
...
Currently, only publishers who are working with X Partner Managers are eligible to apply to the Amplify Program. Please work directly with your Partner Manager if you're interested in submitting an application.

**What are the requirements to be in the program?**

Must be 18 years of age or older.

X account must be in good standing.
...
X will pay publishers sixty (60) days after the last day of the calendar month in which earnings occur. For example, June earnings will be paid at the end of August. Payments are sent automatically and an email notification is sent to the contact name in the payment details.
...
The publisher who has access to the handle credentials. The payment information is masked once entered and we use a third-party processor for payments. The X finance operations team that oversees the payments will have views into the payees to support the business process.
...
If you have any questions regarding the status of any of your open payments, please email [\[email protected\]](
Publishing FAQs
