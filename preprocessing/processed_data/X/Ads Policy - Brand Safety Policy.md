...
_You can view available translations of this article by selecting a language in the bottom-right corner of this page. Translations are provided as a convenience, and are not meant to change the content of our policies. The English version will control and should be your reference in case of conflict between a translation and the English version._
**What’s the policy?**
...
In addition to our Brand Safety policies, which help inform ad placement on X, we also have Advertising Policies that determine permissible content in ads and conduct of advertisers on X. Learn more about our Ads Policies [here.](
...
The above guidelines also apply to content in a newsworthy context, including in relation to time-sensitive events and real-world tragedies. Additionally, content that is considered false or misleading under the [X Rules]( is not eligible for monetization.
**Spam, deceptive, and malicious content**

All publishers that monetize via Amplify Publisher Program must comply with X's platform manipulation and spam rules and [policies.](
...
For additional Paid Partnership guidance, click [here](