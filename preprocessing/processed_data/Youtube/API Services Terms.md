YouTube API Services Terms of Service (EMEA) Stay organized with collections Save and categorize content based on your preferences.
...
The YouTube API Services Terms of Service (TOS) is a comprehensive legal agreement governing developer access and use of YouTube's API services, which includes various policies, guidelines, and obligations that developers must adhere to.

Developers using the YouTube API must comply with the full agreement, including specific terms for data security, user privacy, content handling, branding, and legal compliance, while also understanding YouTube's rights to modify or terminate the services.

YouTube can modify the agreement at any time, and continued use of the API services after these modifications implies the user's acceptance of the new terms, therefore constant vigilance is needed.

The agreement outlines strict consequences for non-compliance, including the suspension or termination of API access, and it also clarifies YouTube's rights regarding data ownership, usage quotas, and the ability to monitor API client activity.

YouTube disclaims all implied warranties not expressly stated, limits their liability in various ways, and requires users to indemnify YouTube against any claims related to the user's API usage or violation of the agreement.
...
**Developer Policies** means the policies relating to the YouTube API Services currently located at [ that you and your API Client(s) are required to comply with in addition to all other terms of the Agreement when accessing, or using, the YouTube API Services .

**Personal Data** has the meaning given in national laws of EU Member State implementing the European Data Protection Directive 95/46/EC, as may be updated, amended and/or replaced from time-to-time.
...
**YouTube Branding Guidelines** means the YouTube API Services Branding Guidelines currently located at [
...
**YouTube Developer Site** means the YouTube developer website including the webpages currently located at [
...
**YouTube Terms** means the YouTube Terms of Service currently located at [
2\. The Agreement.
...
the Google Software Principles currently located at [ and
...
2.3 **Modification of the Agreement.** YouTube may modify the Terms of Service or any of the other documents comprising the Agreement at any time. YouTube will provide notice of changes to the Terms of Service by posting the changes at [ (or any successor URL), and YouTube will notify you of changes to these Terms of Service in written form (by sending you an email, for example) with a minimum of 30 calendar days prior notice before the effective date of such change. YouTube will inform you of the effective date of such changes, the changes will not apply retroactively, and will become effective no sooner than 30 calendar days after posting. However, changes specific to new functionality or changes made for legal reasons may be effective immediately upon notice. If you do not agree to any changes to the Agreement, you must terminate the Agreement. YouTube will inform you about your right to terminate and how to do so. If you do not explicitly terminate, you or your API Client(s)’ continued access to, or use of, the YouTube API Services, including your continued development activities in connection with any YouTube API Services and your API Client(s)’ interaction with any YouTube API Services after the changes to the Agreement takes effect, will be deemed your agreement to and acceptance of such changes.
...
If your API Client(s) uses any YouTube API Services to permit users to upload videos to YouTube websites, applications, services or products, the screen or window in which the end user clicks the "upload" button must display the following warning in the language(s) available on your API Client(s):
...
10.3 **Attribution.** All API Clients must provide proper attribution in accordance with the YouTube Branding Guidelines and these Terms of Service (where applicable) when using the YouTube Brand Features. YouTube reserves the right to determine whether your attribution(s) and display of the YouTube Brand Features comply with the YouTube Branding Guidelines and these Terms of Service. YouTube reserves the right to terminate your licence to display the YouTube Brand Features at any time.
...
**Publicity.** YouTube may use your company or organisation name (or personal name if an individual), product names or logos in presentations, marketing materials, customer lists, financial reports, website listings of customers, research and marketing case studies, and other marketing-related activities, including producing and distributing incidental depictions such as screenshots, video, or other content from your API Client(s). You grant to YouTube and its Affiliates a non-exclusive, irrevocable, royalty-free, worldwide licence to display your company or organisation name (or personal name if an individual), product name or logos for the above purposes. You must not make any public statements regarding your access to, or use of, the YouTube API Services that suggests partnership with, or sponsorship or endorsement by, YouTube without YouTube’s prior review and written approval.
...
14.3 **Special Terms.** Special terms apply to specific versions of the YouTube API Services that are identified as "**Subject API Services**" at [ YouTube will use reasonable efforts to continue to maintain the software code for the Subject API Services for one year from February 10, 2017,
...
16.2 **No Other Rights.** Except for the express rights contained in the Agreement, YouTube grants you no other rights or licences (whether express, implied, by virtue of estoppel or exhaustion, or otherwise) to the YouTube Property or any of YouTube’s or its Affiliates’ intellectual property rights.

16.3 **No Licences or Rights to Patents or Content.** Without limiting the generality of the foregoing, no rights or licences are granted under any patents owned or controlled by YouTube or its Affiliates, and no rights or licences are granted to reproduce or distribute audiovisual content or make audiovisual content available in any manner other than through the use of the YouTube API Services in accordance with the Agreement. All rights not expressly granted to you are reserved by YouTube.
17\. Non-exclusive
...
19.1 **Compliance with the Agreement.** Each party warrants to the other that it will use reasonable care and skill in complying with its obligations under the Agreement.

19.2 **No Warranties.** No conditions, warranties or other terms apply to any service, software, or other goods or services supplied by YouTube or its Affiliates under the Agreement unless expressly stated set out in the Agreement.

19.3 **Additional Disclaimers.** Subject to Section 20.1(a) (Limitation of Liability), all implied conditions, warranties or other terms (including any implied terms as to satisfactory quality, fitness for purpose or conformance with description) are excluded. Specifically, YouTube or its Affiliates does not warrant to you that:
...
the YouTube API Services will be accurate, reliable, complete, continue to exist, or be otherwise valid; or

that defects in the operation or functionality of any aspect of the YouTube API Services, including any software, code, content (including audiovisual content), data, support or anything else provided to you and your API Client(s) as part of, or in connection with, the YouTube API Services, will be corrected.

19.4 **No External Warranties.** To the extent permitted under applicable law, and subject to Section 20(a)(ii), no advice or information, whether oral or written, obtained by you from YouTube, its Affiliates or related parties, or through or from the YouTube API Services, will create any warranty not expressly stated in the Agreement.
...
19.6 **Third-Party Services.** Additionally, the YouTube API Services may contain links to third party websites and online services that are not owned or controlled by YouTube. YouTube has no control over, and assumes no responsibility for, such websites and online services.
...
Nothing in the Agreement will exclude or limit either party’s liability for

death or personal injury resulting from the negligence of either party or their servants, agents or employees;

fraud or fraudulent misrepresentation;

obligations under Section 21 (Indemnification); or

matters that cannot be excluded or limited under applicable law.

Subject to Section 20.1(a) above, YouTube or its Affiliates will not be liable under the Agreement (whether in contract, tort (including negligence) or otherwise) for any special or, indirect losses, loss of profits, loss of revenue, or loss of opportunity, suffered or incurred by you, or otherwise for the deletion or corruption of data, the removal or modification or any aspect of the YouTube API Services, or in relation to any content submitted to YouTube websites, applications, services and products by users or partners, or for the defamatory, offensive, or illegal conduct of any such persons or entities (whether or not such losses were within the contemplation of the parties at the date of the Agreement).

20.2 **Additional Limitations.** To the extent permitted under applicable law and subject to Section 20.1 YouTube’s total liability under or in connection with the this Agreement (whether in contract, tort (including negligence) or otherwise) is limited to the amount paid by you to YouTube to access or use the YouTube API Services for the six months prior to the event giving rise to the liability or £1,000, whichever is higher.
21\. Indemnification

**Indemnification.** You will indemnify YouTube and its Affiliates, directors, officers, employees and users against all liabilities, damages, losses, costs, fees (including legal fees), and expenses relating to any allegation or third-party legal proceeding (any and all of which are "**Claims**") to the extent arising out of or related to:

access to, or any use of the YouTube API Services by you, those acting on your behalf, your API Client(s), or any of your users;

actual or alleged violation of the Agreement (or any portion thereof) by you, those acting on your behalf, your API Client(s), or any of your users, including actual or alleged infringement of any third-party right (including any intellectual property or other proprietary right, confidentiality, privacy right, and right of publicity); or

any content, data, technology or materials provided or contributed by, or through, you, those acting on your behalf, your API Client(s), or any of your users, and not by YouTube, its Affiliates and related parties.

YouTube may at its sole discretion, elect for you to assume control of the defense of the Claim for which you are required to indemnify YouTube and its Affiliates under this Section 21. If the defense or settlement is assumed by you, YouTube may at any time thereafter elect to appoint its own counsel (at its own expense); or YouTube may take over control of the defense and settlement of such Claim. You will not settle any Claim without YouTube’s prior written consent. Both parties will provide reasonable assistance to the other as may be required in order to defend any relevant Claim.
...
25.5 **Requesting Agreement Modifications.** You may grant approvals, permissions and consents to YouTube by email, but any modifications requested by you to the Agreement must be made in writing (not including email) and signed by both YouTube and your authorised representative who has the authority to bind you (and only if YouTube agrees to such modification).
...
25.11 **Governing Law and Venue.** The Agreement, and your relationship with YouTube under the Agreement, will be governed by English law. To the extent permitted by applicable law, you and YouTube agree to submit to the exclusive jurisdiction of the courts of England to resolve any legal matter arising from the Agreement. Notwithstanding this, you agree that YouTube will still be allowed to apply for injunctive remedies (or other equivalent types of urgent legal remedy) in any jurisdiction.
...
25.13 **Translations.** If there is a conflict between the English language terms and any local language translation, the English language terms will govern.